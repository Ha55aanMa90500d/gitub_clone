...
function Navbar() {
  return (
    <ul className="flex c-gp-4 list-none items-center">
      <li className="menu_item">
        <details>
          <summary className="flex c-gp-1 items-end">
            <span>Product</span>
            <svg
              opacity="0.5"
              aria-hidden="true"
          ...
          <div className="flex menu_popup wide_popup">
            <div>
      ...
      <li className="menu_item">
        <details>
          ...
          <div className="flex menu_popup medium_popup">
            <div>
              <div className="flex c-gp-2">
                <svg
                  aria-hidden="true"
      ...
      <li className="menu_item">pricing</li>
    </ul>
  );
}
